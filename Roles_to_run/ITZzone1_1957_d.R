### File for ITZzone1 (Africa) for a 1957-like pandemic with disease-modifying mechanism of action####
...
for (age_groups in 1:5){
  for (countries in country_codes){
    ...
    write_parquet(overall_dt1, sink = here::here('Reduced_run','ITZzone1', paste0('Africa',countries,age_groups,'1957_1d.parquet')), compression = "zstd")
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt2, sink = here::here('Reduced_run','ITZzone1', paste0('Africa',countries,age_groups,'1957_2d.parquet')), compression = "zstd")
    rm(overall_dt2)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt3, sink = here::here('Reduced_run','ITZzone1', paste0('Africa',countries,age_groups,'1957_3d.parquet')), compression = "zstd")
    rm(overall_dt3)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt4, sink = here::here('Reduced_run','ITZzone1', paste0('Africa',countries,age_groups,'1957_4d.parquet')), compression = "zstd")
    rm(overall_dt4)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt5, sink = here::here('Reduced_run','ITZzone1', paste0('Africa',countries,age_groups,'1957_5d.parquet')), compression = "zstd")
    rm(overall_dt5)
    gc()
