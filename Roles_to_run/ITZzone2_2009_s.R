### File for ITZzone2 (Asia-Europe) for a 2009-like pandemic with sterilising mechanism of action####
...
for (age_groups in 1:5){
  for (countries in country_codes){
    ...
    write_parquet(overall_dt1, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'2009_1s.parquet')), compression = "zstd")
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt2, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'2009_2s.parquet')), compression = "zstd")
    rm(overall_dt2)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt3, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'2009_3s.parquet')), compression = "zstd")
    rm(overall_dt3)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt4, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'2009_4s.parquet')), compression = "zstd")
    rm(overall_dt4)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt5, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'2009_5s.parquet')), compression = "zstd")
    rm(overall_dt5)
    gc()
