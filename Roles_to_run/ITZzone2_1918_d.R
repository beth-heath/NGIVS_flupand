### File for ITZzone2 (Asia-Europe) for a 1918-like pandemic with disease_modifying mechanism of action####
...
for (age_groups in 1:5){
  for (countries in country_codes){
    ...
    write_parquet(overall_dt1, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1918_1d.parquet')), compression = "zstd")
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt2, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1918_2d.parquet')), compression = "zstd")
    rm(overall_dt2)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt3, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1918_3d.parquet')), compression = "zstd")
    rm(overall_dt3)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt4, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1918_4d.parquet')), compression = "zstd")
    rm(overall_dt4)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt5, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1918_5d.parquet')), compression = "zstd")
    rm(overall_dt5)
    gc()
