...
for (age_groups in 1:5){
  for (countries in country_codes){
    ...
    write_parquet(overall_dt1, sink = here::here('Reduced_run','ITZzone4', paste0('Europe',countries,age_groups,'Epidemic_1.parquet')), compression = "zstd")
    rm(overall_dt1)
    gc()
    ...
    write_parquet(overall_dt2, sink = here::here('Reduced_run','ITZzone4', paste0('Europe',countries,age_groups,'Epidemic_2.parquet')), compression = "zstd")
    rm(overall_dt2)
    gc()
    ...
    write_parquet(overall_dt3, sink = here::here('Reduced_run','ITZzone4', paste0('Europe',countries,age_groups,'Epidemic_3.parquet')), compression = "zstd")
    rm(overall_dt3)
    gc()
    ...
    write_parquet(overall_dt4, sink = here::here('Reduced_run','ITZzone4', paste0('Europe',countries,age_groups,'Epidemic_4.parquet')), compression = "zstd")
    rm(overall_dt4)
    gc()
    ...
    write_parquet(overall_dt5, sink = here::here('Reduced_run','ITZzone4', paste0('Europe',countries,age_groups,'Epidemic_5.parquet')), compression = "zstd")
    rm(overall_dt5)
    gc()
