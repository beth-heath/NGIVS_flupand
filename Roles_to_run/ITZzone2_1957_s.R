### File for ITZzone2 (Asia-Europe) for a 1957-like pandemic with sterilising mechanism of action####
...
for (age_groups in 1:5){
  for (countries in country_codes){
    ...
    write_parquet(overall_dt1, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1957_1s.parquet')), compression = "zstd")
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt2, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1957_2s.parquet')), compression = "zstd")
    rm(overall_dt2)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt3, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1957_3s.parquet')), compression = "zstd")
    rm(overall_dt3)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt4, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1957_4s.parquet')), compression = "zstd")
    rm(overall_dt4)
    gc()
    ...
    rm(infs_rds_list)
    gc()
    write_parquet(overall_dt5, sink = here::here('Reduced_run','ITZzone2', paste0('Asia-Europe',countries,age_groups,'1957_5s.parquet')), compression = "zstd")
    rm(overall_dt5)
    gc()
